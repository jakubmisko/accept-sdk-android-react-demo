...
/**
 * Created by super on 03.04.2017.
 */
...
//        one.performClick();
//        assertThat(amount.getText().toString(), is("0.01"));
//        one.performClick();
//        assertThat(amount.getText().toString(), is("0.11"));
//        one.performClick();
//        assertThat(amount.getText().toString(), is("1.11"));
//        one.performClick();
//        assertThat(amount.getText().toString(), is("11.11"));
//    }
}
